$(function () {
  ...
  function swiperInfo() {
    ...
    $("#application .swiper-button-prev").mouseenter(function () {
      $("#application .swiper-button-prev img").attr("src","images/leftHover.png")
    }).mouseleave(function () {
      $("#application .swiper-button-prev img").attr("src","images/left.png")
    });

    $("#application .swiper-button-next").mouseenter(function () {
      $("#application .swiper-button-next img").attr("src","images/rightHover.png")
    }).mouseleave(function () {
      $("#application .swiper-button-next img").attr("src","images/right.png")
    });
